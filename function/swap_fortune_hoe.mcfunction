...
data modify storage minecraft:madagascar inbound set from block ~ 250 ~ Items[{Slot:0b}].tag.BlockEntityTag.Items[{id:"minecraft:netherite_hoe", tag:{Enchantments:[{id:"minecraft:fortune", lvl:3s}]}}]
...
data remove block ~ 250 ~ Items[{Slot:0b}].tag.BlockEntityTag.Items[{id:"minecraft:netherite_hoe", tag:{Enchantments:[{id:"minecraft:fortune", lvl:3s}]}}]

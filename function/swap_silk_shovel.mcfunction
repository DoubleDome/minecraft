...
data modify storage minecraft:madagascar inbound set from block ~ 250 ~ Items[{Slot:0b}].tag.BlockEntityTag.Items[{id:"minecraft:netherite_shovel", tag:{Enchantments:[{id:"minecraft:silk_touch", lvl:1s}]}}]
...
data remove block ~ 250 ~ Items[{Slot:0b}].tag.BlockEntityTag.Items[{id:"minecraft:netherite_shovel", tag:{Enchantments:[{id:"minecraft:silk_touch", lvl:1s}]}}]

...
execute store result storage madagascar:horn roll.denom int 1 run scoreboard players get #horn_denom horn_aux
function madagascar:horn/roll with storage madagascar:horn roll
execute if score #horn_roll horn_aux matches 1 run function madagascar:horn/apply_wear

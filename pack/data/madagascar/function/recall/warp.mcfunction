...
data modify storage madagascar:recall dim set from entity @s respawn.dimension
data modify storage madagascar:recall x set from entity @s respawn.pos[0]
data modify storage madagascar:recall y set from entity @s respawn.pos[1]
data modify storage madagascar:recall z set from entity @s respawn.pos[2]
function madagascar:recall/teleport with storage madagascar:recall

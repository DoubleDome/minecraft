...
execute as @e[type=minecraft:arrow,nbt={inGround:1b,item:{components:{"minecraft:custom_data":{bomb:1b}}}}] at @s run function jakarta:arrow/bomb
...
execute as @e[nbt={active_effects:[{id:"minecraft:weakness",amplifier:100b}]}] at @s run function jakarta:arrow/bomb_hit
...
execute as @e[type=minecraft:arrow,nbt={inGround:1b,item:{components:{"minecraft:custom_data":{lightning:1b}}}}] at @s run function jakarta:arrow/lightning
execute as @e[nbt={active_effects:[{id:"minecraft:mining_fatigue",amplifier:100b}]}] at @s run function jakarta:arrow/lightning_hit
...
execute as @e[type=minecraft:arrow,nbt={inGround:1b,item:{components:{"minecraft:custom_data":{charged_bomb:1b}}}}] at @s run function jakarta:arrow/charged_bomb
execute as @e[nbt={active_effects:[{id:"minecraft:unluck",amplifier:100b}]}] at @s run function jakarta:arrow/charged_bomb_hit
...
execute as @e[type=!minecraft:player,nbt={active_effects:[{id:"minecraft:slowness",amplifier:100b}]},tag=!mada_frozen] run function jakarta:arrow/apply_freeze
...
execute as @e[tag=mada_frozen,nbt=!{active_effects:[{id:"minecraft:slowness",amplifier:100b}]}] run function jakarta:arrow/thaw
